...
class UserProjectController extends AbstractController
{
    ...
    {
        return $this->render('user_project/index.html.twig', ['user_projects' => $userProjectRepository->findAll()]);
    }
    ...
    {
        return $this->render('user_project/show.html.twig', ['user_project' => $userProject]);
    }
