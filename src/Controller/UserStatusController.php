...
class UserStatusController extends AbstractController
{
    ...
    {
        return $this->render('user_status/index.html.twig', ['user_statuses' => $userStatusRepository->findAll()]);
    }
    ...
    {
        return $this->render('user_status/show.html.twig', ['user_status' => $userStatus]);
    }
