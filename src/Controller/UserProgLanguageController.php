...
/**
 * @Route("/user/prog/language")
 */
class UserProgLanguageController extends AbstractController
{
    /**
     * @Route("/", name="user_prog_language_index", methods={"GET"})
     */
    public function index(UserProgLanguageRepository $userProgLanguageRepository): Response
    {
        return $this->render('user_prog_language/index.html.twig', ['user_prog_languages' => $userProgLanguageRepository->findAll()]);
    }

    /**
     * @Route("/new", name="user_prog_language_new", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('user_prog_language_index');
        }

        return $this->render('user_prog_language/new.html.twig', [
    ...
    /**
     * @Route("/{id}", name="user_prog_language_show", methods={"GET"})
     */
    public function show(UserProgLanguage $userProgLanguage): Response
    {
        return $this->render('user_prog_language/show.html.twig', ['user_prog_language' => $userProgLanguage]);
    }

    /**
     * @Route("/{id}/edit", name="user_prog_language_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, UserProgLanguage $userProgLanguage): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('user_prog_language_index', ['id' => $userProgLanguage->getId()]);
        }

        return $this->render('user_prog_language/edit.html.twig', [
            'user_prog_language' => $userProgLanguage,
            'form' => $form->createView(),
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="user_prog_language_delete", methods={"DELETE"})
     */
