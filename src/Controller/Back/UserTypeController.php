...
class UserTypeController extends AbstractController
{
    ...
    {
        return $this->render('Back/user_type/index.html.twig', ['user_types' => $userTypeRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('Back/user_type/new.html.twig', [
            'user_type' => $userType,
    ...
    {
        return $this->render('Back/user_type/show.html.twig', ['user_type' => $userType]);
    }
    ...
    public function edit(Request $request, UserType $userType): Response
    {
        ...
        return $this->render('Back/user_type/edit.html.twig', [
            'user_type' => $userType,
            'form' => $form->createView(),
        ]);
    }
